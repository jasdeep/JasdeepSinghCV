#  Data download functions courtesy Darwin Cubi
# https://github.com/DarwinCV/automated-CV
...
create_CV_object <-  function(data_location,
  ...
  if (is_google_sheets_location) {
    ...
    cv$post_info <-
      readr::read_csv(paste0(data_location, "post_info.csv"), skip = 1)
  }
